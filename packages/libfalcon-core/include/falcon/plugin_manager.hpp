...
/**
 * Register protocol handlers that are built into the protocols library.
 *
 * This is implemented outside the core target so `falcon_core` does not need
 * to compile against concrete protocol implementations.
 */
